...
export const Hero = () => {
  return (
    <section
      id="top"
      className="relative flex min-h-screen items-center pt-28 pb-24 sm:pt-32 sm:pb-28 lg:pt-40 lg:pb-32"
    >
          ...
          <div className="order-1 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative transition-transform duration-500 hover:scale-[1.02]">
              ...
              <img
                ...
                alt={PROFILE.name}
                className="relative h-60 w-60 rounded-full object-cover p-1.5 ring-1 ring-white/20 transition-all duration-500 dark:ring-dark-700 sm:h-72 sm:w-72 lg:h-80 lg:w-80"
                style={{
                  background:
