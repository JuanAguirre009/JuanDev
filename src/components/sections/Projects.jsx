...
export const Projects = () => {
  return (
    <section
      id="projects"
      className="pt-28 pb-28 motion-safe:animate-fade-up sm:pt-32 sm:pb-28"
    >
      <Container className="max-w-4xl">
        ...
        <div className="mt-12 flex justify-center">
          ...
          className="inline-flex items-center gap-2 rounded-full border border-primary-400/30 bg-primary-400/10 px-6 py-3 text-sm font-semibold text-primary-400 transition-all duration-300 hover:border-primary-400/60 hover:bg-primary-400/20 hover:text-primary-300"
        >
