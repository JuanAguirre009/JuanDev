              ...
              (link) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-dark-50/80 px-5 py-2.5 text-sm font-semibold text-dark-600 transition hover:-translate-y-0.5 hover:border-primary-400/70 hover:text-primary-500 dark:border-dark-800 dark:bg-dark-900/70 dark:text-dark-100 dark:hover:text-primary-300"
                  >
