  ...
  <ul className="grid grid-cols-2 gap-5 text-[0.8rem] text-dark-600 dark:text-dark-200 sm:grid-cols-3 sm:text-sm">
    {items.map((item) => {
      ...
      return (
        <li
          key={item.name}
          className="group flex flex-col items-center gap-2 rounded-xl py-2 transition-all duration-300 hover:-translate-y-1 hover:bg-dark-100/50 dark:hover:bg-white/[0.03]"
        >
          {item.image ? (
            <img
              src={item.image}
          ...
          <span className="text-center text-[0.8rem] font-medium text-dark-600 transition-colors duration-200 group-hover:text-primary-600 dark:text-dark-200 dark:group-hover:text-primary-300 sm:text-sm">
            {item.name}
          </span>
        </li>
      );
    ...
    <section className="pt-28 pb-28 sm:pt-32 sm:pb-28">
      <Container id="stack" className="max-w-5xl">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          <StackCard glow="rgba(0, 168, 232, 0.18)" className="h-full">
          ...
          <StackCard reverse glow="rgba(148, 163, 184, 0.2)" className="h-full">
          ...
          <StackCard glow="rgba(84, 219, 255, 0.2)" className="h-full">
          ...
          <StackCard reverse glow="rgba(255, 180, 114, 0.2)" className="h-full">
